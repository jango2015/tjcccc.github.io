...
"stage": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid158", tween: [ "motion", "${_arrow-circle-o2a}", [[237,93,0,0],[253.86,53.14,0,0]]], position: 6250, duration: 750 },
            { id: "eid160", tween: [ "motion", "${_arrow-circle-o2a}", [[253.86,53.14,0,0],[281.86,-13.87,0,0]]], position: 7000, duration: 1500 },
            ...
            { id: "eid168", tween: [ "motion", "${_arrow-circle-o3Copy}", [[247.14,96.86,0,0],[221.86,48.86,0,0]]], position: 7000, duration: 750 },
            { id: "eid170", tween: [ "motion", "${_arrow-circle-o3Copy}", [[221.86,48.86,0,0],[177.86,-14.14,0,0]]], position: 7750, duration: 1500 },
            { id: "eid191", tween: [ "style", "${_success}", "left", '324px', { fromValue: '304px'}], position: 10435, duration: 1065 },
            ...
            { id: "eid181", tween: [ "style", "${_arrow-circle-oa}", "top", '29px', { fromValue: '93px'}], position: 7500, duration: 625 },
            { id: "eid183", tween: [ "style", "${_arrow-circle-oa}", "top", '-33px', { fromValue: '29px'}], position: 8125, duration: 1875 },
            { id: "eid135", tween: [ "transform", "${_arrow-circle-o3}", "rotateZ", '-30deg', { fromValue: '-30deg'}], position: 3500, duration: 0 },
            { id: "eid189", tween: [ "style", "${_RoundRect2}", "width", '102px', { fromValue: '0px'}], position: 7000, duration: 3000 },
            { id: "eid192", tween: [ "style", "${_success}", "opacity", '1', { fromValue: '0'}], position: 10435, duration: 1065 },
            ...
            { id: "eid182", tween: [ "style", "${_arrow-circle-oa}", "opacity", '1', { fromValue: '0'}], position: 7500, duration: 625 },
            { id: "eid184", tween: [ "style", "${_arrow-circle-oa}", "opacity", '0', { fromValue: '1'}], position: 8125, duration: 1875 },
            ...
            { id: "eid159", tween: [ "style", "${_arrow-circle-o2a}", "opacity", '1', { fromValue: '0'}], position: 6250, duration: 750 },
            { id: "eid161", tween: [ "style", "${_arrow-circle-o2a}", "opacity", '0', { fromValue: '1'}], position: 7000, duration: 1500 },
            ...
            { id: "eid169", tween: [ "style", "${_arrow-circle-o3Copy}", "opacity", '1', { fromValue: '0'}], position: 7000, duration: 750 },
            { id: "eid171", tween: [ "style", "${_arrow-circle-o3Copy}", "opacity", '0', { fromValue: '1'}], position: 7750, duration: 1500 },
