   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid310", tween: [ "style", "${_portal}", "width", '64px', { fromValue: '64px'}], position: 0, duration: 0 },
            ...
            { id: "eid311", tween: [ "style", "${_portal}", "left", '205px', { fromValue: '205px'}], position: 0, duration: 0 },
