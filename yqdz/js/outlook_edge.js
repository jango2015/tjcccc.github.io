   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid87", tween: [ "style", "${_RoundRect}", "border-bottom-right-radius", [2,2], { valueTemplate: '@@0@@px @@1@@px', fromValue: [2,2]}], position: 0, duration: 0 },
            { id: "eid86", tween: [ "style", "${_RoundRect}", "border-top-right-radius", [2,2], { valueTemplate: '@@0@@px @@1@@px', fromValue: [2,2]}], position: 0, duration: 0 },
            { id: "eid85", tween: [ "style", "${_RoundRect}", "border-top-left-radius", [2,2], { valueTemplate: '@@0@@px @@1@@px', fromValue: [2,2]}], position: 0, duration: 0 },
            ...
            { id: "eid93", tween: [ "gradient", "${_RoundRect}", "background-image", [50,50,true,'farthest-corner',[['rgba(50,153,253,1.00)',0],['rgba(49,105,195,1.00)',100]]], { fromValue: [50,50,true,'farthest-corner',[['rgba(50,153,253,1.00)',0],['rgba(49,105,195,1.00)',100]]]}], position: 0, duration: 0 },
            { id: "eid94", tween: [ "gradient", "${_RoundRect}", "background-image", [50,50,true,'farthest-corner',[['rgba(50,153,253,1.00)',0],['rgba(49,105,195,1.00)',100]]], { fromValue: [50,50,true,'farthest-corner',[['rgba(50,153,253,1.00)',0],['rgba(49,105,195,1.00)',100]]]}], position: 8000, duration: 0 },
            { id: "eid84", tween: [ "style", "${_RoundRect}", "border-bottom-left-radius", [2,2], { valueTemplate: '@@0@@px @@1@@px', fromValue: [2,2]}], position: 0, duration: 0 },
