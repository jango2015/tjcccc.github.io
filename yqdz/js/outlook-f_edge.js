   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid102", tween: [ "style", "${_success}", "width", '341px', { fromValue: '341px'}], position: 0, duration: 0 },
            { id: "eid99", tween: [ "style", "${_success}", "height", '341px', { fromValue: '341px'}], position: 0, duration: 0 },
            { id: "eid100", tween: [ "style", "${_success}", "top", '-63px', { fromValue: '-63px'}], position: 0, duration: 0 },
            ...
            { id: "eid101", tween: [ "style", "${_success}", "left", '200px', { fromValue: '165px'}], position: 0, duration: 5000 },
