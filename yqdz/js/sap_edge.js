   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid38", tween: [ "style", "${_success}", "height", '64px', { fromValue: '64px'}], position: 0, duration: 0 },
            { id: "eid40", tween: [ "style", "${_success}", "top", '66px', { fromValue: '66px'}], position: 0, duration: 0 },
            ...
            { id: "eid39", tween: [ "style", "${_success}", "width", '64px', { fromValue: '64px'}], position: 0, duration: 0 },
